...
define KernelPackage/can
  ...
  AUTOLOAD:=$(call AutoLoad,27,can can-dev)
endef
...
define KernelPackage/can-raw
  ...
  AUTOLOAD:=$(call AutoLoad,27,can-raw)
  $(call AddDepends/can)
endef
...
define KernelPackage/can-bcm
  ...
  AUTOLOAD:=$(call AutoLoad,27,can-bcm)
  $(call AddDepends/can)
endef
...
define KernelPackage/can-gw
  ...
  AUTOLOAD:=$(call AutoLoad,27,can-gw)
  $(call AddDepends/can)
endef
...
define KernelPackage/can-vcan
  ...
  AUTOLOAD:=$(call AutoLoad,27,vcan)
  $(call AddDepends/can)
endef
...
define KernelPackage/can-slcan
  ...
  AUTOLOAD:=$(call AutoLoad,27,slcan)
  $(call AddDepends/can)
endef
...
define KernelPackage/can-flexcan
  ...
  AUTOLOAD:=$(call AutoLoad,27,flexcan)
...
define KernelPackage/can-usb-ems
  ...
  AUTOLOAD:=$(call AutoLoad,27,ems_usb)
...
define KernelPackage/can-usb-esd
  ...
  AUTOLOAD:=$(call AutoLoad,27,esd_usb2)
  $(call AddDepends/can,+kmod-usb-core)
endef
...
define KernelPackage/can-usb-kvaser
  ...
  AUTOLOAD:=$(call AutoLoad,27,kvaser_usb)
  $(call AddDepends/can,+kmod-usb-core)
endef
...
define KernelPackage/can-usb-peak
  ...
  AUTOLOAD:=$(call AutoLoad,27,peak_usb)
  $(call AddDepends/can,+kmod-usb-core)
endef
...
define KernelPackage/can-usb-8dev
  ...
  AUTOLOAD:=$(call AutoLoad,27,usb_8dev)
  $(call AddDepends/can,+kmod-usb-core)
endef
...
define KernelPackage/can-c-can
  ...
  AUTOLOAD:=$(call AutoLoad,27,c_can)
  $(call AddDepends/can)
endef
...
define KernelPackage/can-c-can-platform
  ...
  AUTOLOAD:=$(call AutoLoad,27,c_can_platform)
  $(call AddDepends/can)
endef
...
define KernelPackage/can-c-can-pci
  ...
  AUTOLOAD:=$(call AutoLoad,27,c_can_pci)
  $(call AddDepends/can)
endef
