...
define KernelPackage/ipt-core
  ...
  AUTOLOAD:=$(call AutoLoad,27,$(notdir $(IPT_CORE-m)))
endef
...
define KernelPackage/ipt-conntrack
  ...
  AUTOLOAD:=$(call AutoLoad,27,$(notdir $(IPT_CONNTRACK-m)))
  $(call AddDepends/ipt)
endef
...
define KernelPackage/ipt-nat
  ...
  AUTOLOAD:=$(call AutoLoad,27,$(notdir $(IPT_NAT-m)))
  $(call AddDepends/ipt,+kmod-ipt-conntrack)
endef
...
define KernelPackage/ipt-nathelper
  ...
  AUTOLOAD:=$(call AutoLoad,27,$(notdir $(IPT_NATHELPER-m)))
  $(call AddDepends/ipt,+kmod-ipt-nat)
endef
...
define KernelPackage/ipt-nathelper-extra
  ...
  AUTOLOAD:=$(call AutoLoad,27,$(notdir $(IPT_NATHELPER_EXTRA-m)))
...
define KernelPackage/ipt-nfqueue
  ...
  AUTOLOAD:=$(call AutoLoad,27,$(notdir $(IPT_NFQUEUE-m)))
...
define KernelPackage/nfnetlink
  ...
  AUTOLOAD:=$(call AutoLoad,27,$(notdir $(NFNETLINK-m)))
  $(call AddDepends/ipt)
endef
